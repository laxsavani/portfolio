...
const Footer = () => {
  ...
  const navLinks = ['hero', 'about', 'skills', 'experience', 'projects', 'education', 'contact'];
    ...
    <footer className="bg-surface border-t border-border pt-16 pb-8 px-6 md:px-12">
      <div className="container mx-auto max-w-6xl">
          ...
          <div className="flex flex-col items-start md:items-center">
            ...
            <div className="flex flex-col gap-3">
              ...
              <button
                ...
                className="text-muted font-sans text-sm hover:text-accent transition-colors text-left"
              >
                Certifications
              </button>
            </div>
        ...
        <div className="border-t border-border pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-muted font-sans text-sm">© {currentYear} {resumeData.name}. All rights reserved.</p>
